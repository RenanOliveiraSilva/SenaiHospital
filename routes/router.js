...
router
  ...
  .post(
    "/home/cadastro_funcionario",
    funcionarioController.postCreateFuncionario
  )
...
// //Rotas Médico
router.get("/home/home-medico", medicoController.renderizaHomeMedico);
...
router
  ...
  .get(
    ...
    pacienteController.renderizarAgendamentoConsulta
  )
  .get(
    "/visualizar-cancelar-consultas",
    pacienteController.renderizarCancelarConsulta
  )
  ...
  .get("/consultas", pacienteController.buscarConsultas)
  .get("/consultas/horarios", pacienteController.buscarHorariosDisponiveis)
  .post("/agendar-consulta", pacienteController.agendarConsulta)
  .post("/consultas/cancelar", pacienteController.cancelarConsulta)
  .post("/consultas/reagendar", pacienteController.reagendarConsulta);
